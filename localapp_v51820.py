...
hosp_rate = (
    st.sidebar.number_input("Hospitalization %", 0.0, 100.0, value=1.3, step=0.50, format="%f")/ 100.0)
...
fatal = st.sidebar.number_input(
    "Overall Fatality (%)", 0.0, 100.0, value=0.1 ,step=0.1, format="%f")/100.0

fatal_hosp = st.sidebar.number_input(
    "Hospital Fatality (%)", 0.0, 100.0, value=10.0 ,step=0.1, format="%f")/100.0
...
asymptomatic = 1-(st.sidebar.number_input(
    "Asymptomatic (%)", 0.0, 100.0, value=81.0 ,step=0.1, format="%f")/100.0)

q = 1-(st.sidebar.number_input(
"Symptomatic Isolation Rate (contact tracing/quarantine when symptomatic)", 0.0, 100.0, value=58.0 ,step=0.1, format="%f")/100.0)
