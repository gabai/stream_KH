...
fatal_hosp = st.sidebar.number_input(
    "Hospital Fatality (%)", 0.0, 100.0, value=9.9 ,step=0.5, format="%f")/100.0
...
asymptomatic = 1-(st.sidebar.number_input(
    "Asymptomatic (%)", 0.0, 100.0, value=32.2 ,step=5.0, format="%f")/100.0)
...
"Percent of people adhering to mask-wearing after April 15,2020", 0.0, 100.0, value=38.0 ,step=5.0, format="%f")/100.0)
