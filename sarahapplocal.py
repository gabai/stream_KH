...
"Percent of people adhering to mask-wearing after April 22,2020", 0.0, 100.0, value=30.0 ,step=0.1, format="%f")/100.0)
p_m2 = (st.sidebar.number_input(
"Percent of people adhering to mask-wearing during Phased transitioning", 0.0, 100.0, value=30.0 ,step=0.1, format="%f")/100.0)
...
st.altair_chart(
    ...
    use_container_width=True)
st.subheader("Projected number of **daily** COVID-19 admissions by Hospital: SEIR model Asymptomatic, Presymptomatic")
st.altair_chart(
    hospital_admissions_chart(
        projection_admits_P_ecases, plot_projection_days, as_date=as_date), 
    use_container_width=True)
